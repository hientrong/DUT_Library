<?php
	...
	public function postbyid_home($table_post, $post, $id){
		$sql = "SELECT * FROM $table_post, $post WHERE $table_post.id_category_post=$post.id_category_post AND $post.id_category_post = '$id' ORDER BY $post.id_post DESC";
		return $this->db->select($sql);
	}
	...
	public function categorybyid_post($table_category_post, $cond){
		$sql = "SELECT * FROM $table_category_post WHERE $cond";
		return $this->db->select($sql);
	}
	...
	public function productbyid($table_category_product, $cond){
		$sql = "SELECT * FROM $table_category_product WHERE $cond";
		return $this->db->select($sql);
	...
	public function customer_index($table_customer){
		$sql = "SELECT * FROM $table_customer WHERE customer_id";
		return $this->db->select($sql);
	}
}
