                  ...
                  <div class="container_table">
                     <table class="table table-hover table-condensed">
                              ...
                              <tr class="tr">
                                 ...
                                 <td data-th="Số lượng">
                                    <div class="clear margintop5">
                                       <div class="floatleft"><input type="number" min="0" class="inputsoluong" name="qty[<?php echo $value['product_id'] ?>]"  value="<?php echo $value['product_quantity'] ?>"></div>
                                 ...
                                 <td class="actions aligncenter">
                                    ...
                                    <button type="submit" style="box-shadow: none;margin-top: 5px" value="<?php echo $value['product_id'] ?>" name="update_cart" class="btn btn-sm btn-primary">Cập nhật</button>
                        ...
                        <tfoot>
                           <tr class="tr_last">
                              <td colspan="7">
                                 <a href="<?php echo $_SERVER["HTTP_REFERER"] ?>" class="btn_df btn_table floatleft"><i class="fa fa-long-arrow-left"></i> Tiếp tục mua hàng</a>
                                 <div class="clear"></div>
                              </td>
                           </tr>
                        </tfoot>
                        ...
                        <div class="ch-contacts-details">
                           <ul class="contact-list">
                              <li class="addr">
                                 ...
                                 <p><em><strong>DUT Library</strong></em><br />
                                 <p>54 Nguyễn Lương Bằng</p>
                                 <p> Hotline: 0941.945.167 (zalo)</p>
                                 </p>
                              </li>
                           </ul>
                           <div class="hiring-box">
                              <strong class="title">Chào bạn!</strong>
                              <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi <strong>tronghienne@gmail.com</strong> chúng tôi sẽ giải đáp cho bạn.</p>
