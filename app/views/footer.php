                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           ...
                           <li><a href="#2" class="fb"><img src="<?php echo BASE_URL ?>public/images/Gg.png">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline:0941-945-167 </span>
                                    <span class="text_small">(Từ 7h30 đến 17h từ thứ 2 đến thứ 7)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  tronghienne@gmail.com</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  https://dut.udn.vn/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="footer">
                  <div class="footer-col">
                     ...
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : 54 Nguyễn Lương Bằng <br />
                           Điện thoại: 0941-945-167<br />
                           Email: tronghienne@gmail.com
                        </address>
                        </address>
                     </div>
                  </div>
                  <div class="footer-col">
                     ...
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : 36 Ngô Văn Sở <br />
                           Điện thoại: 0923-032-992<br />
                           Email: hienars2512000@gmail.com
                        </address>
                        </address>
                     </div>
                  </div>
