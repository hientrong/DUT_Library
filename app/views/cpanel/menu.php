		<nav class="navbar navbar-inverse">
  			<div class="container-fluid">
    			<div class="navbar-header">
      				<a class="navbar-brand" href="<?php echo BASE_URL ?>login/dashboard">Admin Library</a>
    			</div>
            ...
            <!-- <li>
              <button type="submit" href="<?php echo BASE_URL ?>login/logout" class="btn btn-default">Đăng xuất</button>
            </li>	 -->	
    		</ul>
  			</div>
		</nav>
